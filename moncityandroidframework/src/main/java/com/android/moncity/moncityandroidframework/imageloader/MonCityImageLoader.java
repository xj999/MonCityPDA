package com.android.moncity.moncityandroidframework.imageloader;
...
import com.android.moncity.moncityandroidframework.imageloader.strategy.BaseImageStrategy;
import com.android.moncity.moncityandroidframework.imageloader.strategy.GlideStrategy;
...
public class MonCityImageLoader {
    ...
    public void loadImage(@NonNull String url,
                          @DrawableRes int placeholder, @NonNull ImageView imageView, @NonNull ImageLoadingListener imageLoadingListener) {
     ...
     * 默认加载图片 /使用默认占位符
     */
    public void loadResourcesGifImage(int url, @NonNull ImageView imageView) {
     ...
     * @param cornerType  自定义圆角类型 CornerType.ALL 4周圆角    CornerType.TOP 头部圆角 具体查看{@link RoundedCornersTransformation.CornerType <tt>RoundedCornersTransformation.CornerType</tt>}
     */
    public void loadCustomRoundImage(@NonNull String url, int radius, int placeHolder, @NonNull RoundedCornersTransformation.CornerType cornerType, @NonNull ImageView imageView) {
        mStrategy.loadCustomRoundImage(url, radius, placeHolder, cornerType, imageView);
    }
