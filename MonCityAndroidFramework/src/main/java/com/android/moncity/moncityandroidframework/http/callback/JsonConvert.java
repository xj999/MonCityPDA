package com.android.moncity.moncityandroidframework.http.callback;

import com.android.moncity.moncityandroidframework.http.MonCityResponse;
import com.android.moncity.moncityandroidframework.http.SimpleResponse;
import com.android.moncity.moncityandroidframework.utils.Convert;
...
public class JsonConvert<T> implements Converter<T> {
    ...
    private T parseParameterizedType(Response response, ParameterizedType type) throws Exception {
        ...
        if (rawType != MonCityResponse.class) {
            ...
            if (typeArgument == Void.class) {
                ...
                MonCityResponse monCityResponse = Convert.fromJson(jsonReader, type);
                response.close();
                int code = monCityResponse.code;
                //这里的0是以下意思
